"""
Django settings for cold_art_41508 project.
...
ROOT_URLCONF = 'cold_art_41508.urls'
...
WSGI_APPLICATION = 'cold_art_41508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_art_41508 API",
    "DESCRIPTION": "API documentation for cold_art_41508 App",
    "VERSION": "v1",
}
